    ...
    <section className="py-16 xl:py-24">
      <GridContainer>
        <div className="w-full max-w-3xl mb-16">
          ...
          <p className="text-lg/relaxed xl:text-xl/6 text-gray-600">We’ve done all the heavy 
             lifting so you don’t have to — get all the
             data you need to launch and grow your business faster.</p>
        </div>

        <div className="flex flex-col xl:flex-row justify-between gap-12 xl:gap-0 items-center">
            <div className="w-full max-w-xl grid xl:grid-cols-2 gap-x-8 gap-y-8 xl:gap-y-16">
              <ItemLaunch 
                number="4,000+"
