    ...
    <section className="py-24">
      <GridContainer>
        <div className="text-center mb-16">
          ...
          <h2 className="text-center text-4xl text-gray-900 tracking-tighter-[-0.72px]
           font-semibold mb-5">
            Cutting-edge features for advanced analytics
          </h2>
          <p className="text-xl/6 text-gray-600 max-w-3xl mx-auto">Powerful, self-serve product and growth analytics to help you 
            convert, engage, and retain more users. Trusted by over 4,000 startups.
          </p>
        </div>

        <div className="grid grid-cols-3 gaap-x-8 gap-y-16">
          <ItemFeature 
          ...
          <ItemFeature 
           ...
           text="Solve a problem or close a sale in real-time with chat. If no 
           one is available, customers are seamlessly routed to email without confusion." 
          />
          <ItemFeature 
           icon={<FiCommand size={24} className="text-brand-600" />} 
           title="Connect the tools you already use" 
           text="Explore 100+ integrations that make your day-to-day workflow 
          ...
          <ItemFeature 
           ...
           text="We’re an extension of your customer service team, and all of 
